...
_Última atualização desta seção: melhoria de Lead Details e padronização de proxy._
...
_Última atualização desta seção: Sistema de permissões unificado (propriedades, empreendimentos e unidades)._
